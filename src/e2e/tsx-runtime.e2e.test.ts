...
describe("E2E: TSX Runtime Compatibility", () => {
	it(
		"tsx src/index.tsx --version outputs version without error",
		() => {
			// Arrange & Act
	...
	it(
		"tsx src/index.tsx --help outputs help without error",
		() => {
			// Arrange & Act
	...
	it(
		"tsx src/index.tsx -v short flag works",
		() => {
			// Arrange & Act
	...
	it(
		"tsx src/index.tsx -h short flag works",
		() => {
			// Arrange & Act
	...
	it(
		"tsx src/index.tsx --unknown-flag shows help",
		() => {
			// Arrange & Act
	...
	it(
		"tsx src/index.tsx with unknown command shows help",
		() => {
			// Arrange & Act
